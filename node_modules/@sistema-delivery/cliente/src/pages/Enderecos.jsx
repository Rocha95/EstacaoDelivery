...
export default function Enderecos() {
  ...
  if (!usuario) return <div className="app-frame"><div className="content"><p>Entre na sua conta para gerenciar seus endereços.</p><button className="btn-block btn-primary" onClick={() => window.location.href='/login?next=/enderecos'}>Entrar</button></div><BottomNav /></div>
          ...
          <>
            {!novo ? (
              ...
              <div className="card">
                ...
                <div className="field">
                  <label>Cidade</label>
                  <input value={form.cidade} onChange={(e) => setForm({ ...form, cidade: e.target.value })} placeholder="Ex: Votorantim" />
                </div>
