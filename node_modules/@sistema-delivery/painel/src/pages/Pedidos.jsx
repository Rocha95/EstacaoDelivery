...
const FILTERS = [
  ...
  { key: STATUS.PRODUCAO, label: STATUS_LABEL[STATUS.PRODUCAO] },
  { key: STATUS.ENTREGA, label: STATUS_LABEL[STATUS.ENTREGA] },
  { key: STATUS.FINALIZADO, label: STATUS_LABEL[STATUS.FINALIZADO] },
]

const NEXT_STATUS = {
  [STATUS.RECEBIDO]: STATUS.PRODUCAO,
  [STATUS.PRODUCAO]: STATUS.ENTREGA,
  [STATUS.ENTREGA]: STATUS.FINALIZADO,
}

const NEXT_LABEL = {
  [STATUS.RECEBIDO]: 'Iniciar produção',
  [STATUS.PRODUCAO]: 'Saiu p/ entrega',
  [STATUS.ENTREGA]: 'Finalizar',
}
